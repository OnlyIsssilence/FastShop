...
public class AnotherLogginActivity extends Activity {                 //登录界面活动
        ...
        public void onClick(View v) {
            switch (v.getId()) {
                case R.id.login_btn_register:                            //登录界面的注册按钮
                    Intent intent_Login_to_Register = new Intent(AnotherLogginActivity.this, RegisterActivity.class);    //切换Login Activity至User Activity
                ...
                case R.id.login_text_change_pwd:                             //登录界面的注销按钮
                    Intent intent_Login_to_reset = new Intent(AnotherLogginActivity.this, ResetpwdActivity.class);    //切换Login Activity至User Activity
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.login_another);
        //通过id找到相应的控件
    ...
    public void login() {                                              //登录按钮监听事件
        if (isUserNameAndPwdValid()) {
            ...
            if(result==1){                                             //返回1说明用户名和密码均正确
                ...
                try {
                    Intent intent = new Intent(AnotherLogginActivity.this, MerchantActivity.class);    //切换Login Activity至User Activity
